                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text"  class="form-control" placeholder="Enter 10 Digit Contac#" name="contact_no" value="{{ old('contact_no') }}" pattern="[0-9]{10}" required>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text"  class="form-control " placeholder="Enter 13 Digit CNIC#" name="cnic" value="{{ old('cnic') }}" pattern="[0-9]{13}">
                                        </div>
                                    </div>
                                </div>
