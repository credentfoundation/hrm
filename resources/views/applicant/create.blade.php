            ...
            <div class="login-box">
                <div class=" card-body card">
                    ...
                    <form class="form" action="{{route('applicant.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal ">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <select name="city" id="city" type="select" class="city form-control">
                                    ...
                                    <option value="Barasat" @if(old("city")=="Barasat" ) selected @endif>Barasat</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group">
                            <button class="btn-submit" type="submit" align="right"> Submit Application</button>
                        </div>
                    </form>
