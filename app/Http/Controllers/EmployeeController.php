...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'contact_no' => 'required|unique:employees|size:10',
            'gender' => 'required',
            'picture' => 'max:1000'
        ...
        if (!strstr(strtolower($request->official_email), 'gmail.com')) {
            return redirect()->back()->with('error', 'Enter correct official email like "abc@gmail.com"');
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            ...
            'contact_no' => 'required|size:10|unique:employees,contact_no,' . $id,
